...
class ECCTest(TestCase):
    ...
    def test_add(self):
        ...
        for x1, y1, x2, y2, x3, y3 in additions:
            p1 = Point(FieldElement(x1, prime),
                       FieldElement(y1, prime),
                       a = a,
                       b = b)
            p2 = Point(FieldElement(x2, prime),
                       FieldElement(y2, prime),
                       a = a,
                       b = b)
            p3 = Point(FieldElement(x3, prime),
                       FieldElement(y3, prime),
                       a = a,
                       b = b)
